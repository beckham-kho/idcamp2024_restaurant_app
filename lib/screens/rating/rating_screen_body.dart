                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                widget.restaurantDetail.customerReviews[index].name,
                              ),
                              Text(
                                widget.restaurantDetail.customerReviews[index].date,
                              ),
                            ],
                          ),
                        ),
                        const SizedBox(height: 5),
                        Text(
                          widget.restaurantDetail.customerReviews[index].review,
                        ),
                      ],
                    ),
                  );  
